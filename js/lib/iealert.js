...
(function ($) {
    function initialize($obj, support, title, text, upgradeTitle, upgradeLink, overlayClose, closeBtn) {
        ...
        var panel = "<div class='ie-l-t-c'></div>"
            ...
            + "<p class='ie-p'>" + text + "<a> http://browsehappy.com/?locale=en </a></span>"
            + "<div class='ie-u'>"
        ...
        function active() {
		 ...
		 if (support === "ie8") {     // the modal box will appear on IE8, IE7, IE6
            if (ie < 9) {
                active();
            }
    ...
    $.fn.iealert = function (options) {
        var defaults = {
            ...
            text:"To get the best possible experience using our site we recommend that you upgrade to a modern web browser. To download a newer web browser click on the Upgrade button. If the Button dosent work here is the Link:",
            upgradeTitle:"Upgrade",
            upgradeLink:"http://browsehappy.com/?locale=en",
            overlayClose:false,
            closeBtn: true
        };
